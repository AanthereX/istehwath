...
const PhoneNumberValidateOtpModal = ({
  phoneNumber = "",
  ...
  const onSubmitHandlerForEditProfile = () => {
    handleSelectedChangeRole(getValues()?.userRole);
    handleSelectedChangeCountry(getValues()?.country);
    handleSelectedChangeCity(getValues()?.city);
...
export default memo(PhoneNumberValidateOtpModal);

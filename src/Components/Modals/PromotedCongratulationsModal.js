...
const PromotedCongratulationsModal = ({
  isOpen,
  setIsOpen,
  modalDialogClassName,
  promotedStartupTitle,
  paidData,
}) => {
  ...
  return (
    <React.Fragment>
      <Confetti numberOfPieces={250} recycle={false} run={isOpen}>
              ...
              <div className='flex min-h-full items-center justify-center p-4 text-center bg-c_7A7A7A bg-opacity-[70%]'>
                ...
                >
                  ...
                  >
                    <div className='text-lg bg-c_292929 md:!w-[60ch] flex w-full justify-center flex-col'>
                      ...
                      <div className='flex flex-col gap-3 w-full'>
                        ...
                        <span className='text-black font-general_medium text-fs_24 block mt-2'>
                          {paidData?.days !== 0
                            ? `${Labels.yourBusinessHasBeenPromotedFor} ${paidData?.days} ${Labels.days}`
                            : Labels.notAvailable}
                        </span>
                      </div>
                    </div>
                    ...
                    <div
                      className={
                        "flex justify-center gap-3 md:flex-row flex-col mt-10"
                      }
                    >
                      <div>
                        <Button
...
export default PromotedCongratulationsModal;

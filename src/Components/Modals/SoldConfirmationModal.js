        ...
        >
          ...
          <div className='fixed inset-0 z-10 overflow-y-auto'>
            <div className='flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0'>
              ...
              >
                <Dialog.Panel className='relative transform overflow-hidden md:min-w-[360px] min-w-[300px] rounded-lg bg-c_FFFFFF text-left shadow-xl transition-all'>
                        ...
                        <div className='mt-2 flex flex-col justify-center items-center'>
                          ...
                          <div className='flex flex-col items-center justify-center gap-y-1 mx-auto'>
                            ...
                            <span className='w-full text-center mx-auto font-general_regular font-normal text-fs_16 text-c_000000'>
                              {`${Labels.areYouSureYouWantToSell}`}
                            </span>
                          </div>
                        </div>
                      </div>
